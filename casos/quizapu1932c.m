...
H=-5500; %depth of top of magma chamber
geometry='cylinder'; %conduit geometry: cylinder or dyke
radius1=30; %cylinder radius or dyke half-width
dl=100; %dyke length (used only if geometry == dyke)

overP1=8e6; % overpressure at the inlet of the conduit
