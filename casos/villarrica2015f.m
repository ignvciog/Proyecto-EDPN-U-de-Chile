...
sio2tot=54.14;
composition='basaltic'; % 'silicic' or 'basaltic' for radrub4 to chose the correct parameters

co=h2o/100; %initial water content in fraction (from 0 to 1)
C1=6.80172e-8; %constant solubility
beta=0.7; %constant solubility
R=461.11; %constant of water
Tc=1130;%temperature in celsius
T=Tc+273.15; %temperature in kelvin


xi=0.25; %initial fraction of crystals (not yet included to estimate density)
xmax=0.45; %maximum crystal content
...
H=-6000; %depth of top of magma chamber
geometry='dyke'; %conduit geometry: cylinder or dyke
radius1=0.9854; %cylinder radius or dyke half-width
dl=200; %dyke length (used only if geometry == dyke)

overP1=1.8759e6; % overpressure at the inlet of the conduit
...
Fc=0.75; % efficiency of bubble coalescense (0 - 1) 

lsup=0.785; % upper limit of bubble content for fragmentation
