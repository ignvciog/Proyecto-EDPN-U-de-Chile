...
El operador directo ya existe: el código \texttt{RIconduitex5\_5.py} (explosivo)
y \texttt{RIconduitef5\_5.py} (efusivo; el mismo DAE, otra salida de tiro),
más las versiones transiente y 2D, resuelven el ascenso de magma como un flujo de
