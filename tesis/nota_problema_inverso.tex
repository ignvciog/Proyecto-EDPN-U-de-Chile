...
El operador directo ya existe. El explosivo es \texttt{RIconduitex5\_5.py};
el efusivo, \texttt{RIconduitef5\_5.py} (el mismo DAE, otra salida de tiro).
Junto con las versiones transiente y 2D, resuelven el ascenso de magma como un flujo de
